...
def get_modified_urdf():
    ...
    # TODO: ------------- start --------------
    # Add virtual base rotation joint (from Lab 2)
...
def move_to_configuration(node, q):
    ...
    q_pitch = q[12]
    q_roll = q[13]
    # send base rotation first, blocking, exactly as in Lab 2
    node.move_to_pose({'rotate_mobile_base': q_rotation}, blocking=True)
    node.move_to_pose({
